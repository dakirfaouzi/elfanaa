...
> = {
  ok: {
    ...
    color: "rgb(var(--fa-positive))",
    bg: "rgb(var(--fa-positive) / 0.10)",
    border: "rgb(var(--fa-positive) / 0.34)",
  },
  degraded: {
    label: "Degraded",
    color: "rgb(var(--fa-warn))",
    bg: "rgb(var(--fa-warn) / 0.10)",
    border: "rgb(var(--fa-warn) / 0.34)",
  },
  down: {
    label: "Down",
    color: "rgb(var(--fa-danger))",
    bg: "rgb(var(--fa-danger) / 0.10)",
    border: "rgb(var(--fa-danger) / 0.34)",
  },
};
  ...
  return (
    <div className="fa-stack">
      ...
      >
        <div className="fa-row" style={{ alignItems: "center", justifyContent: "space-between" }}>
          <div>
            ...
            <div style={{ fontSize: 12.5, color: "rgb(var(--fa-text-muted))", marginTop: 6 }}>
      ...
      <div className="fa-grid fa-grid-3">
        ...
        <div className="fa-card fa-card-pad-lg">
          <div className="fa-row" style={{ alignItems: "center", gap: 10, marginBottom: 10 }}>
            <Database size={16} style={{ color: "rgb(var(--fa-accent-deep))" }} />
          ...
          {data.db.configWarning && (
            <div
              style={{
                ...
                borderRadius: 8,
                border: "1px solid rgb(var(--fa-warn) / 0.25)",
              }}
            >
              {data.db.configWarning}
            </div>
        ...
        <div className="fa-card fa-card-pad-lg">
          <div className="fa-row" style={{ alignItems: "center", gap: 10, marginBottom: 10 }}>
            <Server size={16} style={{ color: "rgb(var(--fa-chart-3))" }} />
          ...
          <div className="fa-row" style={{ justifyContent: "space-between", fontSize: 13 }}>
            <span style={{ color: "rgb(var(--fa-text-muted))" }}>Version</span>
          ...
          <div className="fa-row" style={{ justifyContent: "space-between", fontSize: 13, marginTop: 6 }}>
            <span style={{ color: "rgb(var(--fa-text-muted))" }}>Tables present</span>
          ...
          {data.schema.missing.length > 0 && (
            <div style={{ marginTop: 10, fontSize: 12.5, color: "rgb(var(--fa-warn))" }}>
        ...
        <div className="fa-card fa-card-pad-lg">
          <div className="fa-row" style={{ alignItems: "center", gap: 10, marginBottom: 10 }}>
            <ShieldCheck size={16} style={{ color: "rgb(var(--fa-positive))" }} />
          ...
          {!data.auth.ready && (
            <div style={{ marginTop: 10, fontSize: 12.5, color: "rgb(var(--fa-danger))" }}>
      ...
      <div className="fa-card fa-card-pad-lg">
        ...
        <p style={{ marginTop: 14, fontSize: 12.5, color: "rgb(var(--fa-text-muted))", lineHeight: 1.55 }}>
  ...
  return (
    ...
    >
      <div style={{ minWidth: 0 }}>
        ...
        {detail && (
          <div style={{ fontSize: 11.5, color: "rgb(var(--fa-text-dim))", marginTop: 2 }}>{detail}</div>
        )}
      </div>
      <span
        style={{
          ...
          alignItems: "center",
          gap: 6,
          color: ok ? "rgb(var(--fa-positive))" : "rgb(var(--fa-danger))",
          fontSize: 12.5,
          flexShrink: 0,
          fontWeight: 600,
        }}
